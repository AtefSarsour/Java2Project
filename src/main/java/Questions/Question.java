...
public abstract class Question {
    ...
    public static void sortQuestions() {
        for (int i = 0; i < questions.size(); i++) {
            if (questions.get(i) instanceof TrueFalseQuestion trueFalseQuestion) {
                trueFalseQuestions.add(trueFalseQuestion);
            } else if (questions.get(i) instanceof MCQuestion mCQuestion) {
                mCQuestions.add(mCQuestion);
            } else {
                fillTheBlankQuestions.add((FillTheBlankQuestion) questions.get(i));
            }
        }
    }
    ...
    public static void viewQuestions() {
        for (int i = 0; i < questions.size(); i++) {
            ...
            } else if (questions.get(i) instanceof FillTheBlankQuestion fillTheBlankQuestion) {
    ...
    public void editQuestion() {
        ...
        questionToEdit = questions.get(id - 1);
